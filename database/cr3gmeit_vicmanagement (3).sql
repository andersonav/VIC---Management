...
--
-- Host: localhost:3306
-- Generation Time: 30-Ago-2019 às 19:31
...
--
-- Database: `cr3gmeit_vicmanagement`
--
...
INSERT INTO `usuario` (`usu_id`, `name`, `email`, `password`, `remember_token`, `created_at`, `updated_at`, `tip_usu_id`, `status`) VALUES
(3, 'Anderson Alves', 'anderson.alvesprogrammer@gmail.com', '$2y$10$xm9ckKgmBwZDpxHW.Pp5qOd/61.O3i/YqgVewzV9os9E.hQlRqgZ2', 'Qk2fkn6TXrTRfi1BjJWiqRvx7dawbgcpK3Vzw0h4ousexBk8wikRO1r8GeNT', '2019-08-28 05:05:06', '2019-08-28 05:05:06', 1, 1),
(4, 'Admin', 'admin@gmail.com', '$2y$10$87JPghrSFVvLO6XEBnbdNu8GOYGpoXApjYhIg.qup4CmjZYhTYrd6', '7HqJsoQYsKO2CokHGHQ2ZVNWA310QiuOINt651m8I2uyqd2j9iLBB7oTs2PZ', '2019-08-28 16:44:52', '2019-08-28 16:44:52', 2, 1),
(5, 'Usuário', 'user@gmail.com', '$2y$10$6ND07uDQXM.FECWHCb8qcumMC.SAcY9c9/cEgQkqVvLuQriZh9LrG', 'gRQejJiBirrC4OLjVyh3ulyN7gqKpYoFRAZq2pi06igaCIjDUaaCp2Cgq2kZ', '2019-08-28 19:53:34', '2019-08-28 19:53:34', 3, 1),
(6, 'Alfredo', 'alfredo@gmail.com', '$2y$10$sVizltXfXi213eMF29aCYO8yuw7fD0gbF0skRcPeinfwvpJRzdQPu', 'bX89sCsczoFPg685mZkb2juwHnPAuPZLTlhG8pRCGYnTasE4TiPBXjUf0Mva', '2019-08-29 04:14:44', '2019-08-29 04:14:44', 3, 1),
(7, 'Anderson Alves', 'a@gmail.com', '$2y$10$zp1bTJQSPbO1zSm2hDWp9Owm1Z7Qq50ZGN4qI3lnm2VuqtUC3TvHe', NULL, '2019-08-30 00:40:43', '2019-08-30 00:40:43', 3, 0),
(8, 'Anderson Alves', 'aaaaa@gmail.com', '$2y$10$qzlsI28CUyPI.C17NlVuXOok.29iwVjFjJKgrsj0MJEjb28rtGMQC', 'zA1cvR9flMxP6TnBqzKGiTESAMHOfIjPiPwelmTrQEqy6KUqEjvtN41bv3zr', '2019-08-30 00:46:13', '2019-08-30 00:46:13', 3, 0),
(9, 'Anderson Alves', 'aaaaaaaa@gmail.com', '$2y$10$hFEzMFRrBDFrcfsZDqoyT.QNGJAiW6qojhYUsuQCuKx0s0HwbPDRi', NULL, '2019-08-30 00:47:44', '2019-08-30 00:47:44', 3, 0),
(10, 'rigoberto', 'rigoberto.alfredo@gmail.com', '$2y$10$EnYtYMuyL7DCIiD2t4Ghs.y2SpRQZW.GPF3Grzgy3/PsuqLLnmKHC', NULL, '2019-08-30 14:36:34', '2019-08-30 14:36:34', 1, 1);
...
--
-- Indexes for table `menu_tipo_usuario`
--
...
--
-- Indexes for table `sub_menu_tipo_usuario`
--
...
ALTER TABLE `usuario`
  ...
  ADD KEY `tipo_usuario_fk` (`tip_usu_id`);
...
--
-- AUTO_INCREMENT for table `atividade1`
--
ALTER TABLE `atividade1`
  MODIFY `ati1_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT for table `atividade2`
--
ALTER TABLE `atividade2`
...
--
-- AUTO_INCREMENT for table `menu_tipo_usuario`
--
ALTER TABLE `menu_tipo_usuario`
...
--
-- AUTO_INCREMENT for table `sub_menu_tipo_usuario`
--
ALTER TABLE `sub_menu_tipo_usuario`
