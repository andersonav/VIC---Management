...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Heading -->
            <!--Vou comentar interface-->
            <!--<div class="sidebar-heading">
        Interface
      </div>-->

            <!-- Nav Item - Pages Collapse Menu -->
            <!--Vou comentar componentes-->
            <!--<li class="nav-item">
        ...
        <a class="nav-link" href="charts.php">
          ...
          <span>Charts</span></a>
            ...
            <a class="nav-link" href="{{$item->men_rota}}">
                <i class="{{$item->men_icone}}"></i>
                <span>{{$item->men_nome}}</span>
            </a>
            @else
            <li class="nav-item">
                <a class="nav-link collapsed" href="javascript:void(0);" data-toggle="collapse" data-target="#{{$item->attrId}}" aria-expanded="true" aria-controls="collapsePages">
                    <i class="{{$item->men_icone}}"></i>
                    <span>{{$item->men_nome}}</span>
                </a>
                ...
                <div id="{{$item->attrId}}" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{$item->tip_usu_attr .'/'. $rotaSubMenu[$countRota ++]}}">{{$itemSubMenu}}</a>
                        @endforeach
                    </div>
                </div>
            </li>
